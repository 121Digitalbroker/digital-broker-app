    ...
    <section className="relative w-full flex flex-col">
      ...
      <div className="relative w-full min-h-screen flex flex-col items-center justify-center overflow-hidden pt-20 pb-20 px-6 md:px-12 bg-black">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center my-auto w-full">
          <h1 className="animate-fade-in-up animation-delay-200 mb-6 flex flex-col items-center justify-center" style={{ lineHeight: '1.1' }}>
            <div className="flex flex-col md:flex-row items-center gap-2 md:gap-8 justify-center mb-4">
              <span className="text-white uppercase" style={{ fontSize: 'clamp(3rem, 10vw, 6rem)', fontWeight: 900, letterSpacing: '-0.02em' }}>
                Yamuna
              </span>
              <span className="text-orange-500 uppercase" style={{ fontSize: 'clamp(3rem, 10vw, 6rem)', fontWeight: 900, letterSpacing: '-0.02em' }}>
                Expressway
              </span>
            </div>
            <span className="block text-white uppercase italic tracking-[0.3em] font-light" style={{ fontSize: 'clamp(1rem, 2.5vw, 1.8rem)' }}>
