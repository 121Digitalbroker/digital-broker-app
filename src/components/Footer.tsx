...
const Footer = () => {
  return (
    <footer className="bg-white pt-24 pb-12 border-t border-gray-100 container mx-auto px-6 md:px-12 text-left">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">
            924, Tower B, Bhutani Alphathum, Sector 90, Noida (U.P) 201305<br />
